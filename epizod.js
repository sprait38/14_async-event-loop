...
export function render(data) {
  ...
  if (data.episode_id === 4) {
    appContainer.style.backgroundImage = 'url(img/episod-IV.jpeg)';
  }
  if (data.episode_id === 5) {
    appContainer.style.backgroundImage = 'url(img/episod-V.jpg)';
  }
  if (data.episode_id === 6) {
    appContainer.style.backgroundImage = 'url(img/episod-VI.jpg)';
  }
  if (data.episode_id === 1) {
    appContainer.style.backgroundImage = 'url(img/episod-I.jpg)';
  }
  if (data.episode_id === 2) {
    appContainer.style.backgroundImage = 'url(img/episod-II.jpg)';
  }
  if (data.episode_id === 3) {
    appContainer.style.backgroundImage = 'url(img/episod-III.webp)';
  }
